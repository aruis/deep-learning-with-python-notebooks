...
这本书已经出了两版了，不过到目前为止，第二版还没有引进国内，而第一版是由人民邮电图灵引进的，已经是2018年的事了。但是书中的demo，几乎都还是可用的状态，所以我正在把相关的代码微调，以保证它们可以在`keras 2.8`下可以运行。相关代码改进会逐步提交到`first_edition`文件夹，具体可以查看提交记录。
